...
if (typeof(WCMMode) == "undefined" || WCMMode != "EDIT") {
	...
	(function($) {
		...
		if (streamTarget) {
			...
			"query": "childrenof:" + currentURL + "* type:comment -source:Twitter state:Untouched,ModeratorApproved sortOrder:reverseChronological children:3",
			"truncateReplies": {
			    "after" : 10,
			    "clickable": true
			},
...
$(document).ready(function() {
	...
	setTimeout(function() {
		...
		if ($wpjQ('#wapolabs_wrapperLoginStatus a .lnk_login').text() == 'Log in') {
			...
			var domain = '';
			if (slatest_public_url.indexOf("dev") != -1 || slatest_public_url.indexOf("local") != -1) {
