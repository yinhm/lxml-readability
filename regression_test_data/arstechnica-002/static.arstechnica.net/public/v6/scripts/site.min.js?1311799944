 ...
 * Copyright (c) 2009 Conde Nast Digital
 */
(function(c){c.fn.oembed=function(f,e,g){e=c.extend(true,c.fn.oembed.defaults,e);return this.each(function(){var h=c(this),i=(f!=null)?f:h.attr("href"),j;if(!g){g=function(l,k){c.fn.oembed.insertCode(l,e.embedMethod,k)}}if(i!=null){j=d(i);if(j!=null){j.maxWidth=e.maxWidth;j.maxHeight=e.maxHeight;j.params=e[j.name]||{};j.embedCode(h,i,g);return}}g(h,null)})};c.fn.oembed.defaults={maxWidth:640,maxHeight:null,embedMethod:"replace"};c.fn.oembed.insertCode=function(f,g,e){var h;switch(g){case"auto":if(f.attr("href")!=null){insertCode(f,"append",e)}else{insertCode(f,"replace",e)}break;case"replace":f.replaceWith(e.code);break;case"fill":f.html(e.code);break;case"append":h=f.next();if(h==null||!h.hasClass("oembed-container")){h=f.after('<div class="oembed-container"></div>').next(".oembed-container");if(e!=null&&e.provider_name!=null){h.toggleClass("oembed-container-"+e.provider_name)}}h.html(e.code);break}};c.fn.oembed.getPhotoCode=function(e,g){var h=g.title?g.title:"",f;h+=g.author_name?" - "+g.author_name:"";h+=g.provider_name?" - "+g.provider_name:"";f='<div><a href="'+e+'" target="_blank"><img src="'+g.url+'" alt="'+h+'"/></a></div>';if(g.html){f+="<div>"+g.html+"</div>"}return f};c.fn.oembed.getVideoCode=function(e,g){var f=g.html;return f};c.fn.oembed.getRichCode=function(e,g){var f=g.html;return f};c.fn.oembed.getGenericCode=function(e,g){var h=(g.title!=null)?g.title:e,f='<a href="'+e+'">'+h+"</a>";if(g.html){f+="<div>"+g.html+"</div>"}return f};c.fn.oembed.isAvailable=function(e){var f=d(e);return(f!=null)};function d(e){for(var f=0;f<b.length;f++){if(b[f].matches(e)){return b[f]}}return null}var b=[new a("googlevideo","video.google."),new a("hulu","hulu.com"),new a("metacafe","metacafe.com"),new a("qik","qik.com"),new a("revision3","slideshare"),new a("viddler","viddler.com"),new a("vimeo","vimeo.com","http://vimeo.com/api/oembed.json"),new a("youtube","youtube.com"),new a("yfrog","yfrog.com")];function a(e,f,h,g){this.name=e;this.urlPattern=f;this.oEmbedUrl=(h!=null)?h:"http://oohembed.com/oohembed/";this.callbackparameter=(g!=null)?g:"callback";this.maxWidth=640;this.maxHeight=null;this.matches=function(i){return i.indexOf(this.urlPattern)>=0};this.getRequestUrl=function(m){var k=this.oEmbedUrl,j="",l;if(k.indexOf("?")<=0){k=k+"?"}for(l in this.params){if(l==this.callbackparameter){continue}if(this.params[l]!=null){j+="&"+escape(l)+"="+this.params[l]}}k+="format=json";if(this.maxWidth!=null){k+="&maxwidth="+this.maxWidth}if(this.maxHeight!=null){k+="&maxheight="+this.maxHeight}k+="&url="+escape(m)+j+"&"+this.callbackparameter+"=?";return k};this.embedCode=function(i,k,l){var j=this.getRequestUrl(k);c.getJSON(j,function(q){var m=c.extend(q),o,n=q.type;switch(n){case"photo":m.code=c.fn.oembed.getPhotoCode(k,q);break;case"video":m.code=c.fn.oembed.getVideoCode(k,q);break;case"rich":m.code=c.fn.oembed.getRichCode(k,q);break;default:m.code=c.fn.oembed.getGenericCode(k,q);break}l(i,m)})}}})(jQuery);jQuery.fn.highlightFade=function(f){var j=(f&&f.constructor==String)?{start:f}:f||{};var h=jQuery.highlightFade.defaults;var e=j.interval||h.interval;var b=j.attr||h.attr;var g={linear:function(d,i,a,k){return parseInt(d+(k/a)*(i-d))},sinusoidal:function(d,i,a,k){return parseInt(d+Math.sin(((k/a)*90)*(Math.PI/180))*(i-d))},exponential:function(d,i,a,k){return parseInt(d+(Math.pow(k/a,2))*(i-d))}};var c=(j.iterator&&j.iterator.constructor==Function)?j.iterator:g[j.iterator]||g[h.iterator]||g.linear;if(h.iterator&&h.iterator.constructor==Function){c=h.iterator}return this.each(function(){if(!this.highlighting){this.highlighting={}}var i=(this.highlighting[b])?this.highlighting[b].end:jQuery.highlightFade.getBaseValue(this,b)||[255,255,255];var k=jQuery.highlightFade.getRGB(j.start||j.colour||j.color||h.start||[255,255,128]);var a=jQuery.speed(j.speed||h.speed);var d=j["final"]||(this.highlighting[b]&&this.highlighting[b].orig)?this.highlighting[b].orig:jQuery.curCSS(this,b);if(j.end||h.end){d=jQuery.highlightFade.asRGBString(i=jQuery.highlightFade.getRGB(j.end||h.end))}if(typeof j["final"]!="undefined"){d=j["final"]}if(this.highlighting[b]&&this.highlighting[b].timer){window.clearInterval(this.highlighting[b].timer)}this.highlighting[b]={steps:((a.duration)/e),interval:e,currentStep:0,start:k,end:i,orig:d,attr:b};jQuery.highlightFade(this,b,j.complete,c)})};jQuery.highlightFade=function(d,b,f,c){d.highlighting[b].timer=window.setInterval(function(){var e=c(d.highlighting[b].start[0],d.highlighting[b].end[0],d.highlighting[b].steps,d.highlighting[b].currentStep);var a=c(d.highlighting[b].start[1],d.highlighting[b].end[1],d.highlighting[b].steps,d.highlighting[b].currentStep);var g=c(d.highlighting[b].start[2],d.highlighting[b].end[2],d.highlighting[b].steps,d.highlighting[b].currentStep);jQuery(d).css(b,jQuery.highlightFade.asRGBString([e,a,g]));if(d.highlighting[b].currentStep++>=d.highlighting[b].steps){jQuery(d).css(b,d.highlighting[b].orig||"");window.clearInterval(d.highlighting[b].timer);d.highlighting[b]=null;if(f&&f.constructor==Function){f.call(d)}}},d.highlighting[b].interval)};jQuery.highlightFade.defaults={start:[255,255,128],interval:50,speed:400,attr:"backgroundColor"};jQuery.highlightFade.getRGB=function(e,b){var a;if(e&&e.constructor==Array&&e.length==3){return e}if(a=/rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(e)){return[parseInt(a[1]),parseInt(a[2]),parseInt(a[3])]}else{if(a=/rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(e)){return[parseFloat(a[1])*2.55,parseFloat(a[2])*2.55,parseFloat(a[3])*2.55]}else{if(a=/#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(e)){return[parseInt("0x"+a[1]),parseInt("0x"+a[2]),parseInt("0x"+a[3])]}else{if(a=/#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(e)){return[parseInt("0x"+a[1]+a[1]),parseInt("0x"+a[2]+a[2]),parseInt("0x"+a[3]+a[3])]}else{return jQuery.highlightFade.checkColorName(e)||b||null}}}}};jQuery.highlightFade.asRGBString=function(b){return"rgb("+b.join(",")+")"};jQuery.highlightFade.getBaseValue=function(h,d,c){var g,f;c=c||false;f=d=d||jQuery.highlightFade.defaults.attr;do{g=jQuery(h).css(f||"backgroundColor");if((g!=""&&g!="transparent")||(h.tagName.toLowerCase()=="body")||(!c&&h.highlighting&&h.highlighting[d]&&h.highlighting[d].end)){break}f=false}while(h=h.parentNode);if(!c&&h.highlighting&&h.highlighting[d]&&h.highlighting[d].end){g=h.highlighting[d].end}if(g==undefined||g==""||g=="transparent"){g=[255,255,255]}return jQuery.highlightFade.getRGB(g)};jQuery.highlightFade.checkColorName=function(a){if(!a){return null}switch(a.replace(/^\s*|\s*$/g,"").toLowerCase()){case"aqua":return[0,255,255];case"black":return[0,0,0];case"blue":return[0,0,255];case"fuchsia":return[255,0,255];case"gray":return[128,128,128];case"green":return[0,128,0];case"lime":return[0,255,0];case"maroon":return[128,0,0];case"navy":return[0,0,128];case"olive":return[128,128,0];case"purple":return[128,0,128];case"red":return[255,0,0];case"silver":return[192,192,192];case"teal":return[0,128,128];case"white":return[255,255,255];case"yellow":return[255,255,0]}};ars.interior={};ars.interior.minimum_font_size=8;ars.interior.maximum_font_size=22;ars.interior.liveblog_refresh_rate=1000*60*1;ars.staff={caesar:"Editor in Chief","ken fisher":"Editor in Chief","jon stokes":"Deputy Editor",hannibal:"Deputy Editor",john:"Apple Technology Specialist","john siracusa":"Apple Technology Specialist","ben kuchera":"Gaming Editor",eric:"Managing Editor","eric bangeman":"Managing Editor",clintology:"Tech Director","clint ecker":"Tech Director","lee aylward":"Programmer",leedo:"Programmer",ejacqui:"Senior Editor","jacqui cheng":"Senior Editor",aurich:"Creative Director","aurich lawson":"Creative Director",zeotherm:"Science Contributor","matt ford":"Science Contributor","dr. jay":"Science Editor","john timmer":"Science Editor",smykes:"Contributing Writer","jeff smykil":"Contributing Writer",segphault:"Open Source Editor","ryan paul":"Open Source Editor",foresmac108:"Contributing Writer","chris foresman":"Contributing Writer","nate anderson":"Senior Editor","andrew webster":"Gaming Contributor",andrewwebster:"Gaming Contributor","iljitsch van beijnum":"Contributing Writer",iljitsch:"Contributing Writer","matthew lasar":"Contributing Writer","michael thompson":"Gaming Contributor",vansau:"Gaming Contributor","Aaron Zimmerman":"Copy Editor","Peter Bright":"Contributing Writer",drpizza:"Contributing Writer","Casey Johnston":"Contributing Writer","Johnathan M. Gitlin":"Contributing Writer",drjonboyg:"Contributing Writer","Tim Lee":"Tech Policy Contributor"};ars.interior.listing_page=2;ars.interior.default_page_size=25;ars.interior.page_size=ars.interior.default_page_size;ars.interior.loaded_media_css=false;ars.interior.get_more_posts=function(c,g){var e=window.location.pathname,f,b,a,d;c=c||false;ars.pageview(e+"index.ars?page="+ars.interior.listing_page);ars.event("Interactions","Loaded more posts",window.location.href+"?page="+ars.interior.listing_page);f=((ars.interior.listing_page-1)*ars.interior.page_size)||0;d="view=fragment&v=listing&s="+f+"&l="+ars.interior.page_size;if(c){d+="&exclude_secondary=true"}else{d+="&exclude_secondary=false"}$.ajax({type:"GET",url:e,data:d,dataType:"html",success:g,error:function(h){ars.log("ajax failure!")}});ars.interior.listing_page++};ars.interior.hijack_discussion_links=function(){$("#content .story-inner").each(function(a,c){var b=$(".title a",c).attr("href"),d=$(".comment-link a",c),e=$(".etc-icon a",c);if(d.length&&d[0].href.match(/episteme/)){if(e.length!==0){b=e.attr("href")}d.attr("href",b+"?comments=1#comments-bar")}})};ars.interior.hijack_more_links=function(){if(fp_layout!=="compact"){$(".story-inner").each(function(a,b){$("p:last",b).append($("a.read-more",b).css("padding-left","5px"))})}};ars.interior.setup_liveblog_timers=function(){if($(".liveblog").length){ars.interior.lb_timer=setInterval(function(){ars.pageview()},ars.interior.liveblog_refresh_rate)}};ars.interior.setup_code_highlighting=function(){var a=$("<link>");if($("pre[name='code']").length!==0&&typeof(syntaxhighlighter!=="undefined")){$.getScript(syntaxhighlighter);a.attr("rel","stylesheet").attr("type","text/css").attr("media","screen");a.attr("href","http://arstechnica.com/mt-static/plugins/ArsTheme/style/code_syntax_highlighting.css");$("body").append(a)}};ars.interior.font_size=function(a){return function(){var c=$("#story, .comment"),b=parseInt(c.css("font-size").replace("px",""),10),d=a||"enlarge";if(d==="shrink"){if(b>ars.interior.minimum_font_size){b-=1}ars.event("Interactions","Font Resize","shrink")}else{ars.event("Interactions","Font Resize","enlarge");if(b<ars.interior.maximum_font_size){b+=1}}c.css("font-size",b+"px");$.cookie("story-font-size",b,{path:"/",expires:365});return false}};ars.interior.fix_relative_links=function(){var a,b;loc=window.location.pathname.split("/");a=loc.pop();if(typeof(public_slug)!=="undefined"){a=public_slug}if(a===""){a="1"}page=parseInt(a,10)||null;if($(".pagebreak").length>1||(page!==null&&page===1)){if(page!==null&&page==1){a=loc.pop()}var c=new RegExp("^("+a+"/)?(\\d+)(#(.*))?$","i");console.log("Page Regex: "+c);$("#story .body a").each(function(f,g){var d,e=$(g).attr("href");if(typeof(e)!="undefined"){console.log(e);if(page!==null&&page===1&&(d=e.match(c))){loc=window.location.pathname.split("/");loc=loc.splice(0,loc.length-2);loc.push(e);loc=loc.join("/");$(g).attr("href",loc)}else{if(d=e.match(c)){if(typeof(d[3])!=="undefined"){$(g).attr("href",d[3])}else{$(g).attr("href","#page-"+d[2])}}}}})}};ars.interior.setup_video=function(){if($(".BrightcoveExperience").length!==0){$.getScript("http://admin.brightcove.com/js/BrightcoveExperiences.js",function(){if(typeof(brightcove)!=="undefined"){brightcove.createExperiences()}})}};ars.interior.setup_webfonts=function(){var a="http://fonts.googleapis.com/css?family=Maven+Pro";css=$("<link>").attr("rel","stylesheet").attr("type","text/css").attr("media","screen").attr("href",a);$("head").append(css)};ars.interior.load_media_css=function(a){if(typeof(a)!=="string"){return}if(ars.interior.loaded_media_css===false){css=$("<link>").attr("rel","stylesheet").attr("type","text/css").attr("media","screen").attr("href",a);$("head").append(css);ars.interior.loaded_media_css=true}};ars.interior.load_media_js=function(b,a){if(typeof(a)!=="function"){return}if(!(jQuery().mediaelementplayer)){$.getScript(b,a)}else{a()}};ars.interior.setup_html5video=function(){var c,b,d,a,e;if($("video").length===0){return}debugMode=(window.location.search.indexOf("?debug")!==-1)?true:false;cssFile=debugMode?"/public/v6/vendor/mediaelement/mediaelementplayer.css?v=3":"/public/v6/vendor/mediaelement/mediaelementplayer.min.css?v=3";cdnDomain="";if(!debugMode){cdnDomain="http://static.arstechnica.net"}jsFile=debugMode?"/public/v6/vendor/mediaelement/mediaelement-and-player.js?v=3":"/public/v6/vendor/mediaelement/mediaelement-and-player.min.js?v=3";ars.interior.load_media_css(cdnDomain+cssFile);ars.interior.load_media_js(cdnDomain+jsFile,function(){$("video").mediaelementplayer()})};ars.interior.setup_audio=function(){var c,b,d,a,e;if($("audio").length===0){return}debugMode=(window.location.search.indexOf("?debug")!==-1)?true:false;cssFile=debugMode?"/public/v6/vendor/mediaelement/mediaelementplayer.css?v=3":"/public/v6/vendor/mediaelement/mediaelementplayer.min.css?v=3";cdnDomain="";if(!debugMode){cdnDomain="http://static.arstechnica.net"}if($("audio.standalone").length!==0){jsFile=debugMode?"/public/v6/vendor/mediaelement/mediaelement-and-player.js?v=3":"/public/v6/vendor/mediaelement/mediaelement-and-player.min.js?v=3";ars.interior.load_media_css(cdnDomain+cssFile);ars.interior.load_media_js(cdnDomain+jsFile,function(){$("audio.standalone").mediaelementplayer({audioWidth:640})})}if($("a.inline-audio").length!==0){jsFile=debugMode?"/public/v6/vendor/mediaelement/mediaelement.js?v=3":"/public/v6/vendor/mediaelement/mediaelement.min.js?v=3";e=function(){$("a.inline-audio").each(function(g,j){var h=$("audio",j),f;f=new MediaElement(h[0],{flashName:cdnDomain+"/public/v6/vendor/mediaelement/flashmediaelement.swf"});$(this).click(function(i){return function(k){if(window.navigator.userAgent.indexOf("Firefox/3.0")===-1){k.preventDefault()}else{return true}if(f.paused){f.play()}else{f.pause()}}}(f))})};if(typeof(MediaElement)==="undefined"){$.getScript(cdnDomain+jsFile,e)}else{e()}}};ars.interior.setup_popup_windows=function(){windowed_links=$("a[target=ars_image_popup]");windowed_links.click(ars.interior.handle_popup)};ars.interior.handle_popup=function(i){var c=$(this).attr("href"),f,a,q,h,l,o="",k="",g,b,d,j,n,m;f=$(this).data("target-width")||null;a=$(this).data("target-height")||null;if(!(c&&f&&a)){return true}q=$(this).data("target-caption")||null;h=$(this).data("caption-position")||null;l=q||"Ars Image Popup";if(q){if(h){h=h.split(":");caption_position_css=h[0]+":5px;"+h[1]+":5px;";k='<span style="position:absolute;'+caption_position_css+'z-index:10;background-color: rgba(0,0,0,0.6);padding:5px;color:white;font-family: Helvetica, Arial, sans-serif;">'+q+"</span>";o="position:absolute;top:0;left:0;z-index:1;"}else{k='<div style="line-height:1.7em;height:25px;max-height:25px;overflow:hidden;margin:0;padding:0;background-color: black; color: white; padding:5px;font-family: Helvetica, Arial, sans-serif;">'+q+"</div>";o="display:block;";a=a+35}}if($.browser.opera){a=a+35}else{if($.browser.mozilla){a=a+50}}g=f/a;b=window.screen.availWidth||window.screen.width;d=window.screen.availHeight||window.screen.height;if(f>b){f=b;a=f/g}else{if(a>d){a=d;f=d*g}}j="menubar=no,location=no,resizable=yes,scrollbars=no,status=no,height="+(a)+",width="+(f);if(window.ars_popup_window){window.ars_popup_window.close();delete (window.ars_popup_window)}if(c.indexOf("html")===-1){m="about:blank"}else{m=c}window.ars_popup_window=window.open(m,"ars_image_popup",j);if(typeof(window.ars_popup_window)!=="undefined"&&!window.Touch){i.preventDefault();if(c.indexOf("html")===-1){window.ars_popup_window.document.write('<!DOCTYPE html><html style="margin:0;padding:0;" lang="en"><head><title>'+l+'</title><meta name="charset" content="utf-8"></head><body style="margin:0;padding:0;overflow:hidden;background:#ccc;"><img style="'+o+'" src="'+c+'" />'+k+"</body></html>");window.ars_popup_window.document.close()}if(!$.browser.webkit||n){window.ars_popup_window.resizeTo(f,a)}}};ars.interior.setup_swappable_images=function(){$("div.swappable").each(function(b,g){var a="",f,c,d;$("img",this).last().addClass("hidden");f=function(){$("img",this).last().removeClass("hidden");$("img",this).first().addClass("hidden")};c=function(){$("img",this).first().removeClass("hidden");$("img",this).last().addClass("hidden")};if(window.Touch){$(this).bind("touchend",function(h){console.log("touch ended");if($("img",this).last().hasClass("hidden")){$("img",this).last().removeClass("hidden");$("img",this).first().addClass("hidden")}else{$("img",this).first().removeClass("hidden");$("img",this).last().addClass("hidden")}})}else{$(this).hover(f,c)}});$("div.swappable+.news-item-figure-caption .news-item-figure-caption-text").each(function(a,b){if(window.Touch){$(b).text("Tap to swap: "+$(b).text())}else{$(b).text("Hover to swap: "+$(b).text())}})};ars.interior.get_share_scripts=function(){$.getScript("http://platform.twitter.com/widgets.js");$.getScript("http://static.addtoany.com/menu/page.js");$.getScript("https://apis.google.com/js/plusone.js")};ars.interior.prepare_technopaedia=function(){$("#technopaedia h4").append('<div class="toggle">&nbsp;</div>').find(".toggle").bind("click",function(){$("#technopaedia li").toggleClass("collapsed");if($("#technopaedia li").hasClass("collapsed")){$.cookie("technopaedia-collapsed","true",{path:"/",expires:365})}else{$.cookie("technopaedia-collapsed","false",{path:"/",expires:365})}});if($.cookie("technopaedia-collapsed")=="true"){$("#technopaedia li").addClass("collapsed")}};ars.interior.search=function(){var d,a,c,b;if(window.location.hash){d=$("input.gsc-input");a=$("input.gsc-search-button");if(d.length!==0&&a.length!==0){c=unescape(/#(.*)$/.exec(window.location.hash)[1].replace(/\+/g," "));b=$("form.gsc-search-box");b.after('<h3 class="page">Page 1 of results</h3>');d[0].click();d[0].focus();d.val(c);a[0].focus();a[0].click();document.title="Ars Search"}else{setTimeout(ars.interior.search,500)}}};ars.interior.switch_journal_tab=function(b,f){var e="",a,d,c;f=f||false;if(f){$.cookie("journal-box-category",b,{path:"/",expires:365})}b=b||"all";$("#journals-box .category li").removeClass("selected");$("#journals-box .category li."+b).addClass("selected");e=$("#journals-box .category li."+b+" a")[0].href;d="view=sidebar-fragment";return $.ajax({type:"GET",url:e,data:d,dataType:"html",success:(function(g,h){return function(i){$("#journals-box .stories li").remove();$("#journals-box .stories").append(i);if(h){ars.pageview(window.location.pathname+"?journal-tab="+g);ars.event("Interactions","Journals Box Tab",g)}}}(b,f)),error:function(g){ars.log("ajax failure!")}})};ars.interior.prepare_journals_box=function(){$("#journals-box .category li a").live("click",function(){var a=$(this).parents("li");if(a.hasClass("selected")){return true}a=a[0].className;ars.interior.switch_journal_tab(a,true);return false})};ars.interior.prepare_new_comments=function(){var a;if(typeof(entry_author)!=="undefined"){a=entry_author}else{a={}}$(document).ready(function(){$("div.comment").each(function(c,f){var j=$(".author",$(this)).attr("data-post-author"),g=null,b=false,h=false,d=null;if((j in ars.staff)||(j.toLowerCase() in ars.staff)){g=ars.staff[j]||ars.staff[j.toLowerCase()];b=true}if((j in a)||(j.toLowerCase() in a)){h=true}if(h||b){d=" ( ";if(b&&g){d+=g}if(b&&h){d+=" / "}if(h){d+="Author";$(this).addClass("by-author")}else{$(this).addClass("by-staff")}d+=" )";$(".author a",$(this)).text(j+d)}else{$(this).removeClass("by-author").removeClass("by-staff")}});if(window.location.hash.indexOf("comment-")!==-1){$(window.location.hash+" .body").highlightFade({start:[248,226,152],speed:1500});ars.scroll_to_id(window.location.hash.substring(1))}})};ars.interior.highlight_elements_from_hash=function(c,d){var b,a;b=new RegExp(c,"i");if(window.location.hash.search(b)!==-1){a=parseInt(window.location.hash.match(b)[1],10);if(a>0&&d[a-1]!==undefined){ars.scroll_to_element($(d[a-1]),-15);$(d[a-1]).highlightFade({start:[248,226,152],speed:1500})}}};ars.interior.prepare_article=function(){ars.interior.setup_webfonts();ars.interior.fix_relative_links();ars.interior.setup_popup_windows();ars.interior.setup_swappable_images();ars.interior.setup_audio();ars.interior.setup_liveblog_timers();ars.interior.setup_video();ars.interior.setup_html5video();ars.interior.setup_code_highlighting();ars.interior.prepare_technopaedia();$(".game-info .footer a").live("click",function(a){ars.event("Interactions","Clicked GameInfo Buy Button",window.location.href)})};ars.interior.init=function(){if($("body").hasClass("homepage")){return}if($("body").hasClass("individual")){var a,b;ars.interior.highlight_elements_from_hash("#p(\\d+)",$("#story .body p"));a=$("#story .body")[0];b=$("h1,h2,h3,h4,h5,h6",a);ars.interior.highlight_elements_from_hash("#h(\\d+)",b);if(new_comments){ars.interior.prepare_new_comments()}$(".enlarge-text a").live("click",ars.interior.font_size("enlarge"));$(".shrink-text a").live("click",ars.interior.font_size("shrink"));$(".print a").live("click",function(){window.print();ars.event("Interactions","Printed Article",window.location.href);return false});$(".single-page a").live("click",function(){if($(this).hasClass("nonsub")){ars.event("Interactions","All-on-one (Nonsub)",window.location.href)}else{ars.event("Interactions","All-on-one (Sub)",window.location.href)}});$(".multi-page a").live("click",function(){ars.event("Interactions","Multi-page (sub)",window.location.href)});$(".pdf a").live("click",function(){if($(this).hasClass("nonsub")){ars.event("Interactions","PDF (Nonsub)",window.location.href)}else{ars.event("Interactions","PDF (Sub)",window.location.href)}});$("a.comments-link").live("click",function(){ars.event("Interactions","Viewed Comments",window.location.href)});$("div.comment a.quotelink").live("click",function(){ars.event("Interactions","Quoted a comment",window.location.href)});$("div.comment a.editlink").live("click",function(){ars.event("Interactions","Edited a comment",window.location.href)});$("div.comments-pager li a").live("click",function(){ars.event("Interactions","Paged Through Comments",window.location.href)});$("div.next-page a").live("click",function(){ars.event("Interactions","Clicked Comments Next",window.location.href)});if(typeof(entry_author)!=="undefined"){ars.interior.entry_author=entry_author||{}}else{ars.interior.entry_author={}}}$("#journals-box .stories li a").live("click",function(){var c=$(this).parents("li")[0].id;ars.event("Interactions","Journals Box Item",c);if($("body").hasClass("archive")){ars.event("Landing Page",$(this).attr("href"),c)}else{if($("body").hasClass("individual")){ars.event("Article Page",$(this).attr("href"),c)}}});$(".archive .story a").live("click",function(){var c=$(this).parents()[0].className;var d=$(this).parents("div.story")[0].id;if(c===""||typeof(c)==="undefined"){c=this.className}ars.event("Landing Page",$(this).attr("href"),d+"-"+c)});$(".individual #read-more-stories ul a").live("click",function(){var c=$(this).parents("div")[0].className;var d=$(this).parents("li")[0].id;ars.event("Article Page",$(this).attr("href"),d+"-"+c)});$(".individual .story-navigation a").live("click",function(){var c="prev-next-link";ars.event("Article Page",$(this).attr("href"),c)});$(document).ready(function(){if($("body").hasClass("individual")){ars.interior.prepare_article()}else{$("#more-stories a").live("click",function(){ars.interior.get_more_posts(false,function(c){$("#all-stories").append(c);ars.interior.hijack_discussion_links();ars.interior.hijack_more_links();ars.setup_time()});return false});if(window.location.pathname.indexOf("/search/")===0){$(".gsc-cursor-page").live("click",function(){var d=$("input.gsc-input"),c=$("h3.page");ars.scroll_top();c.replaceWith('<h3 class="page">Page '+this.innerHTML+" of results for "+d.val()+"</h3>")});$(".gsc-search-button").live("click",function(){var c=$("input.gsc-input");window.location.hash=escape(c.val().replace(/\s+/g,"+"));document.title=c.val()+" - Ars Search"});$(".gsc-clear-button").live("click",function(){window.location.hash=""});$(document).ready(ars.interior.search)}}});ars.interior.hijack_discussion_links();ars.interior.hijack_more_links();ars.interior.prepare_journals_box();if(window.location.search==="?success=true"){$("#FormConfirmation").show()}};ars.interior.init();