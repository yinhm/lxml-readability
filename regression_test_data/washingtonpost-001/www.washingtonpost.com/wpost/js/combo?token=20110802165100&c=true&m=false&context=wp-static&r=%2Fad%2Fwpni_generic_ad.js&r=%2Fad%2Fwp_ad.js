...
wpniAds.templates.rules.local336x60={what:["336x60"],where:["local/front"],when:["201108020000/201108082359"]};
wpniAds.templates.initRule("capdish2");
wpniAds.templates.rules.capdish2={what:["336x60"],where:(function(){return(typeof estNowWithYear!="undefined"&&estNowWithYear<="201108082359"?["lifestyle/food/front"]:["lifestyle/food/front","local/front"]);
...
}if(typeof wp_meta_data!=="undefined"&&wp_meta_data.contentType&&wp_meta_data.contentType[0]==="CompoundStory"&&typeof revsci==="function"&&revsci().match(/j10513|j10186|j10567|j10406|j10303|j10145/)){wpniAds.templates.initRule("revsci_levers");
wpniAds.templates.rules.revsci_levers={what:["leaderboard_2","extra_bb"],where:[""],when:["201107150000/201112312359"]};
