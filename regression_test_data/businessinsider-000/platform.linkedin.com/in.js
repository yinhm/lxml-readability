(function(){var p=document,k=(/^https?:\/\/.*?linkedin.*?\/in\.js.*?$/),b=(/async=true/),A=(/^https:\/\//),G=(/\/\*((?:.|[\s])*?)\*\//m),C=(/\r/g),h=(/[\s]/g),f=(/^[\s]*(.*?)[\s]*:[\s]*(.*)[\s]*$/),y=(/^[\s]+|[\s]+$/g),j="\n",D=",",m="",F="@",O="&",n="extensions",o="api_key",R="on",v="onDOMReady",T="onOnce",S="script",I="https://www.linkedin.com/uas/js/userspace?v=0.0.1128-RC2.7511-1337",g="https://platform.linkedin.com/js/secureAnonymousFramework?v=0.0.1128-RC2.7511-1337",E="http://platform.linkedin.com/js/nonSecureAnonymousFramework?v=0.0.1128-RC2.7511-1337",z=p.getElementsByTagName("head")[0],t=p.getElementsByTagName(S),a=[],K={},c=false,U,l,P,r,H,B,d;
